...
- 固定下载入口：`https://github.com/errtry/cps-client-releases/releases/latest`
...
scripts/publish-release.sh v1.2.3-test.1 /path/to/CPSClient-Setup.exe errtry/cps-client-releases
```

发布完成后打开：

```text
https://github.com/errtry/cps-client-releases/releases/latest
```
...
下载地址：https://github.com/errtry/cps-client-releases/releases/latest
本次重点：xxx
...
```text
https://github.com/errtry/cps-client-releases/releases
```
